            ...
            <div>
                ...
                <div class="flex h-[80px] justify-between items-center absolute z-10">
                    ...
                    <a href="https://immortal.gamesxtra.net/#">
                        <img class="w-[136px] h-[40px] mt-[20px] ml-[16px] lg:ml-[120px]" src="/assets/Logo.png" />
                    </a>
                    {/* guide */}
                    <div>
                ...
                {/* Content 1 or header*/}
                <div class="bg-cover bg-center h-[750px] z-0" style={{ backgroundImage: 'url("/assets/Background Section 1.jpg")' }}>
                    <div class="flex flex-col lg:flex-row-reverse lg:pt-[48px] lg:ml-[100px]">
                        {/* moving image */}
                        <img class="mx-auto w-[424px] h-[268px] top-40 moving-image z-0 lg:h-[400px] lg:w-[650px]" src="/assets/Image Hero Section 1.png" />
                        <div class="flex flex-col items-center mt-20 z-40">
                            {/* logo middle */}
                            <img class="w-[284px] h-[84px] z-0 lg:w-[404px] lg:h-[120px]" src="/assets/Logo.png" />
                            {/* text middle */}
                            ...
                            <div class="flex gap-4 mx-5 lg:w-[400px]">
                                <a href="https://play.google.com/store/apps/details?id=com.extralife.android.ilegend">
                                    <img class="" src="/assets/Button Google Play.png" />
                                </a>
                                <a href="https://immortal.gamesxtra.net/#">
                                    <img class="" src="/assets/Button Apple Store.png" />
                                </a>
                            </div>
                            {/* gift button */}
                            <div class="relative">
                                <button onClick={openModal}>
                                    <img class="w-[180px] h-[65px] lg:w-[240px] lg:h-[80px] m-8" src="/assets/Button Gift Code.png"></img>
                ...
                {/* content 2 */}
                <div class="bg-cover bg-center h-[750px] z-0" style={{ backgroundImage: 'url("/assets/Background Section 2.jpg")' }}>
                    <div class="flex flex-col justify-center items-center lg:flex-row">
                        ...
                        <div class="relative lg:m-20">
                            ...
                            <div class="flex flex-col items-center">
                                <img class="mx-auto w-[400px] h-[218px]" src="/assets/Video Background.png" />
                                <div class="absolute">
                        ...
                        {/* hero image */}
                        <img class="lg:w-[705px] lg:h-[502px] w-[328px] h-[234px] mt-11 lg:mt-[100px]" src="/assets/Image Hero Section 2.png"></img>
                    </div>
                </div>
                {/* contain 3 */}
                <div class="bg-cover bg-center h-[896px] z-0" style={{ backgroundImage: 'url("/assets/Background Section 3.jpg")' }}>
                    {/* text */}
                ...
                {/* content 4 */}
                <div class="bg-cover bg-center h-[593px] md:h-[793px] lg:px-20 lg:h-[940px] z-0 " style={{ backgroundImage: 'url("/assets/Background Section 4.jpg")' }}>
                    ...
                    <div class="flex flex-col lg:flex-row justify-between pt-[80px] relative lg:h-[50px]">
                        ...
                        <div class="lg:flex lg:flex-row text-center lg:ml-10">
                            <div class="flex justify-center">
                                <img class="w-10 h-10 lg:w-16 lg:h-16" src="/assets/favicon.png" alt="" />
                            </div>
                        ...
                        <div class="justify-center self-center relative -bottom-[71px] lg:-top-[0px]">
                            <img class="" src="/assets/Character Footer.png" alt="" />
                        </div>
                        {/* button social media */}
                        <div class="flex-row hidden lg:block lg:ml-[30px] lg:mr-5">
                            <button class="mx-2">
                                <img src="/assets/Button Footer Play Now.png" alt="" />
                            </button>
                            <button class="mx-2">
                                <img src="/assets/Button Footer Facebook.png" alt="" />
                            </button>
                            <button class="mx-2">
                                <img src="/assets/Button Footer Instagram.png" alt="" />
                            </button>
                            <button class="mx-2 mr-5">
                                <img src="/assets/Button Footer Discord.png" alt="" />
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <Modal isOpen={isModelOpen} onClose={closeModal}>
                    {/* background */}
                    <div class="merriweather-text text-center text-md bg-cover bg-center" style={{ backgroundImage: 'url("/assets/Background Pop Up.jpg")' }}>
                        {/* modal contents */}
                        ...
                        <div class="relative mt-10 flex flex-col items-center">
                            <a>
                                <img class="w-[70x] h-[70px]" src="/assets/Button Gift Code.png" ></img>
                        ...
                        <div class="flex flex-row mt-3 justify-center">
                            <img class="w-[120px] mx-1" src="/assets/item/Silver.png" alt="" />
                            <img class="w-[120px] mx-1" src="/assets/item/Golden Scroll.png" alt="" />
                            <img class="w-[120px] mx-1" src="/assets/item/1.5X Exp Potion.png" alt="" />
                        </div>
                        {/* 2nd coupon */}
                        <div class="relative mt-10 flex flex-col items-center">
                            <a>
                        ...
                        <div class="flex flex-row flex-wrap mt-3 justify-center">
                            <img class="w-[120px] mx-1" src="/assets/item/Lv.2 Attack Gem.png" alt="" />
                            <img class="w-[120px] mx-1" src="/assets/item/Silver2.png" alt="" />
                            <img class="w-[120px] mx-1" src="/assets/item/Secret Code of the Abyss.png" alt="" />
                            <img class="w-[120px] mx-1 mt-2" src="/assets/item/Treasure Vault Key.png" alt="" />
                        </div>
                        {/* 3rd coupon */}
                        <div class="relative mt-10 flex flex-col items-center">
                            <a>
                        ...
                        <div class="flex flex-row flex-wrap mt-3 justify-center">
                            <img class="w-[120px] mx-1" src="/assets/item/Lv.3 Attack Gem.png" alt="" />
                            <img class="w-[120px] mx-1" src="/assets/item/Red Equipment Optional.png" alt="" />
                            <img class="w-[120px] mx-1" src="/assets/item/3X Exp Potion.png" alt="" />
                        </div>
                        {/* 4th coupon */}
                        <div class="relative mt-10 flex flex-col items-center">
                            <a>
                        ...
                        <div class="flex flex-row flex-wrap mt-3 justify-center pb-5">
                            <img class="w-[120px] mx-1" src="/assets/item/Personal Name Change Card.png" alt="" />
                            <img class="w-[120px] mx-1" src="/assets/item/Golden Hammer.png" alt="" />
                            <img class="w-[120px] mx-1" src="/assets/item/Order-Spirit.png" alt="" />
                        </div>
                    </div>
                </Modal>
            </div>
